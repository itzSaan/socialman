        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 section-title">
              <h2>Subscribe</h2>
              <h1><span>Subscribe</span> To Get Latest Updates From Us</h1>
            </div>
            <div className="col-lg-6">
              <p className="mt-4">Stay ahead of the game! Subscribe to our newsletter for the latest digital marketing tips, trends, and exclusive updates straight to your inbox.</p>
              <form ref={form} onSubmit={sendSubscribeEmail} method="post" className="php-email-form">
                ...
                <div className="col-md-12 text-center">
                  ...
                  {isSuccess && <div className="sent-message">Thank you for Subscribing! Welcome to our Family</div>}
                </div>
              </form>
            </div>
          </div>
